...
namespace PithFront\PithPackFaIcons;

use Pith\Workflow\PithRoute;

/**
 * Class FaIconsResourceRoute
 */
class FaIconsResourceRoute extends PithRoute
{
    public string $pack            = 'PithFront\\PithPackFaIcons\\FaIconsResourcePack';
